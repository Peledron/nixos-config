{ config, lib, pkgs, system, imputs, ... }:
{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-44a170bc-eea7-4f7a-a391-94c0b018d273" = [ ];
      ...
      "bismuth"."decrease_window_height" = "Meta+Shift+Down";
      ...
      "bismuth"."increase_window_height" = "Meta+Shift+Up";
      ...
      "org.kde.konsole.desktop"."_launch" = ["Meta+C" "Ctrl+Alt+T"];
      "org.kde.krunner.desktop"."RunClipboard" = "Alt+Shift+F2";
      "org.kde.krunner.desktop"."_launch" = ["Alt+Space" "Search" "Meta+Space" "Alt+F2"];
    ...
    files = {
      ...
      "dolphinrc"."Notification Messages"."ConfirmHide" = false;
      "kactivitymanagerdrc"."activities"."44a170bc-eea7-4f7a-a391-94c0b018d273" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "44a170bc-eea7-4f7a-a391-94c0b018d273";
      "kcminputrc"."Libinput.1452.595.bcm5974"."ClickMethod" = 1;
      "kcminputrc"."Libinput.1452.595.bcm5974"."LmrTapButtonMap" = true;
      "kcminputrc"."Libinput.1452.595.bcm5974"."MiddleButtonEmulation" = true;
      "kcminputrc"."Libinput.1452.595.bcm5974"."NaturalScroll" = true;
      "kcminputrc"."Libinput.1452.595.bcm5974"."TapToClick" = true;
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "853,596";
      "kdeglobals"."General"."AllowKDEAppsToRememberWindowPositions" = true;
      "kdeglobals"."General"."XftHintStyle" = "hintslight";
      "kdeglobals"."General"."XftSubPixel" = "none";
      "kdeglobals"."General"."fixed" = "Source Code Pro Semibold,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."font" = "Verdana,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."menuFont" = "Verdana,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."smallestReadableFont" = "Verdana,8,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."toolBarFont" = "Verdana,10,-1,5,50,0,0,0,0,0";
      ...
      "kdeglobals"."WM"."activeFont" = "Verdana,10,-1,5,50,0,0,0,0,0";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{789bfd53-67ad-46e2-91c6-a19ecd489fca}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{e749ef9a-01fe-400b-8555-7063f16731c9}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{5a109169-1c05-46ba-8073-04f28eff1fdb}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{4afd71f4-734a-4d31-9bae-0c126d7e08b5}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{b42b2b40-1c22-4eea-869a-420d6b2181cd}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{8cfd6868-8006-4d4d-af26-4c9152a0aa57}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{5a95432b-0600-4ca0-91d2-c3ab4a31fbe9}";
      ...
      "kwalletrc"."Wallet"."Local Wallet" = "pengolodh";
      ...
      "kwinrc"."Desktops"."Id_1" = "71ddb0c4-9205-453b-8c8c-b5749a3fc4d6";
      "kwinrc"."Desktops"."Id_2" = "006eeb02-5b84-41e6-9795-d87a2e9fb1a3";
      "kwinrc"."Desktops"."Id_3" = "d2bac649-6203-4ffc-a766-fecdc4d64b3f";
      "kwinrc"."Desktops"."Id_4" = "2732200e-4064-4959-8a7a-205da5b877dd";
      ...
      "kwinrc"."Tiling.c115fea0-aee8-5691-b780-3a12b69b4474"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Xwayland"."Scale" = 1;
      "kxkbrc"."Layout"."DisplayNames" = ",";
      "kxkbrc"."Layout"."LayoutDefaultGlobal" = 1;
      "kxkbrc"."Layout"."LayoutList" = "be,us";
