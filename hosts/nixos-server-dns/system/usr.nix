   ...
   users = {
      ...
      users = {
         ...
         pengolodh = {
            ...
            extraGroups = [ "wheel" "podman" "kvm" "libvirtd" ]; # add user to groups for extra permissions like sudo access
            ...
            openssh = {
               ...
               authorizedKeys = {
                  keys = [
                     "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIPk3nsMqW3510sd9kktNqfM3YuP1qUzTscNg0VWDEJX4"
                  ];
               };
            };
