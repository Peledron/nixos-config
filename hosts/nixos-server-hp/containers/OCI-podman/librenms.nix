  ...
  systemd = {
    ...
    services = {
      ...
      "podman-network-librenms_default" = {
        ...
        script = ''
          podman network exists librenms_default || podman network create --ipv6 -o vlan=${builtins.toString (builtins.elemAt extraVar.vlans 2)} -o isolate=1 librenms_default
        '';
